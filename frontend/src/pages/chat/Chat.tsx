                ...
                <Stack horizontal className={styles.chatRoot}>
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Start chatting with coffee product assistant</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>This chatbot is configured to answer coffee product questions</h2>
                            </Stack>
                        ) : (
                        ...
                        <Stack horizontal className={styles.chatInput}>
                            ...
                            <QuestionInput
                                clearOnSend
                                placeholder="Type a product question..."
                                disabled={isLoading}
                                onSend={(question, id) => {
